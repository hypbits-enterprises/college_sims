<div class="staffinformed hide" id='informationwindow'>
    ...
    <div class="credentials">
        ...
        <div class="row">
            ...
            <div class="col-md-4">
                <label class="form-control-label" for="tscnosd"><b>TSC No: </b><br></label>
                <input class="form-control w-100" type="text" name="tscnosd" id="tscnosd" placeholder = 'TSC No' autocomplete="off" >
            </div>
            <div class="col-md-4">
